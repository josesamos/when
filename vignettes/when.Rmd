...
The rest of this document is structured as follows: First, the general process of defining these dimensions is presented. Next, a section is dedicated to the definition of dimensions based on time and another to dimensions based on date. Finally, the document ends with conclusions and bibliography.
