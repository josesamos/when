...
If we want to work with the dimension at the week level, we may be interested in having the start or end date for each one. To obtain them and be able to use them to generate the dimension, we have the `get_week_date_range()` function.
