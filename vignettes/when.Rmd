...
The rest of this document is structured as follows: First, the general process of defining dimensions is presented. Next, a section is dedicated to the definition of dimensions based on time and another to dimensions based on date. We continue explaining the export of the generated tables in various formats. Finally, the document ends with conclusions and bibliography.
